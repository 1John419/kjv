(function () {
  ...
  const versionCheck = async (version) => {
    let currentVersion = dbVersion();

    let db = new $n(tomeName);
  ...
  class BookmarkFolderAddView {
    ...
    buildPage() {
      ...
      this.dialog = templateDivDialog('bookmark-folder-add', dialogToolset$5);
  ...
  class BookmarkFolderDeleteView {
    ...
    buildPage() {
      ...
      this.dialog = templateDivDialog('bookmark-folder-delete', dialogToolset$4);
      this.scroll.appendChild(this.dialog);
      this.page.appendChild(this.scroll);
  ...
  class BookmarkFolderRenameView {
    ...
    buildPage() {
      ...
      this.dialog = templateDivDialog('bookmark-folder-rename', dialogToolset$3);
      this.scroll.appendChild(this.dialog);
  ...
  class BookmarkExportview {
    ...
    buildPage() {
      ...
      this.dialog = templateDivDialog('bookmark-export', dialogToolset$2);
      this.scroll.appendChild(this.dialog);
      this.page.appendChild(this.scroll);
  ...
  class BookmarkImportView {
    ...
    buildPage() {
      ...
      this.dialog = templateDivDialog('bookmark-import', dialogToolset$1);
      this.scroll.appendChild(this.dialog);
