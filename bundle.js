(function () {
  ...
  class NavigatorModel {
    ...
    restoreTask() {
      ...
      if (!validTasks$3.includes(navigatorTask)) {
        navigatorTask = defaultTask;
      }
  ...
  class BookmarkModel {
    ...
    restoreTask() {
      ...
      if (!bookmarkTask) {
        ...
        } else if (!validTasks$2.includes(bookmarkTask)) {
          bookmarkTask = defaultTask;
        }
      }
  ...
  const upperToolSet$e = [{type: 'btn-banner', cssModifier: 'bookmark-list',
  ...
  class BookmarkFolderAddView {
    ...
    buildPage() {
      ...
      this.dialog = template.divDialog('bookmark-folder-add', dialogToolset$5);
  ...
  const upperToolSet$a = [{ type: 'banner', cssModifier: 'bookmark-folder-delete',
    text: 'Folder Delete' },];
  ...
  class BookmarkFolderDeleteView {
    ...
    buildPage() {
      ...
      this.dialog = template.divDialog('bookmark-folder-delete', dialogToolset$4);
      this.scroll.appendChild(this.dialog);
      this.page.appendChild(this.scroll);
  ...
  const upperToolSet$9 = [{type: 'banner', cssModifier: 'bookmark-folder-rename',
    text: 'Folder Rename'},];
  ...
  class BookmarkFolderRenameView {
    ...
    buildPage() {
      ...
      this.dialog = template.divDialog('bookmark-folder-rename', dialogToolset$3);
      this.scroll.appendChild(this.dialog);
  ...
  class BookmarkExportview {
    ...
    buildPage() {
      ...
      this.dialog = template.divDialog('bookmark-export', dialogToolset$2);
      this.scroll.appendChild(this.dialog);
      this.page.appendChild(this.scroll);
  ...
  class BookmarkImportView {
    ...
    buildPage() {
      ...
      this.dialog = template.divDialog('bookmark-import', dialogToolset$1);
      this.scroll.appendChild(this.dialog);
  ...
  class SearchModel {
    ...
    restoreTask() {
      ...
      } else if (!validTasks$1.includes(searchTask)) {
        searchTask = defaultTask;
      }
  ...
  const upperToolSet$6 = [{type: 'btn-banner', cssModifier: 'search-result',
